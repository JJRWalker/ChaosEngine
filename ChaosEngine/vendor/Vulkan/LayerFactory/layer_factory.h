...
class layer_factory {
    public:
        ...
        virtual VkDeviceAddress PreCallGetBufferDeviceAddressKHR(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo){ PreCallApiFunction("vkGetBufferDeviceAddressKHR"); return 0; };
        virtual VkDeviceAddress PostCallGetBufferDeviceAddressKHR(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo){ PostCallApiFunction("vkGetBufferDeviceAddressKHR"); return 0; };
        virtual uint64_t PreCallGetBufferOpaqueCaptureAddressKHR(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo) { PreCallApiFunction("vkGetBufferOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
        virtual uint64_t PostCallGetBufferOpaqueCaptureAddressKHR(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo) { PostCallApiFunction("vkGetBufferOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
        virtual uint64_t PreCallGetDeviceMemoryOpaqueCaptureAddressKHR(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfoKHR* pInfo) { PreCallApiFunction("vkGetDeviceMemoryOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
        virtual uint64_t PostCallGetDeviceMemoryOpaqueCaptureAddressKHR(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfoKHR* pInfo) { PostCallApiFunction("vkGetDeviceMemoryOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
...
#endif
        virtual VkDeviceAddress PreCallGetBufferDeviceAddressEXT(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo){ PreCallApiFunction("vkGetBufferDeviceAddressEXT"); return 0; };
        virtual VkDeviceAddress PostCallGetBufferDeviceAddressEXT(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo){ PostCallApiFunction("vkGetBufferDeviceAddressEXT"); return 0; };
