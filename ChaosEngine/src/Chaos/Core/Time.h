...
namespace Chaos
{
	class Time
	{
		...
		static void Init() {
			...
			m_unscaledFixedDeltaTime = 0.016f;
			m_fixedDeltaTime = 0.016f;
			m_timeSinceLastFixedUpdate = 0.0f;
		}
		
		inline static float GetDeltaTime() { return m_deltaTime; }
		inline static float GetUnscaledDeltaTime() { return m_unscaledDeltaTime; }
		inline static float GetFixedDeltaTime() { return m_fixedDeltaTime; }
		inline static float GetUnscaledFixedDeltaTime() { return m_unscaledFixedDeltaTime; }
